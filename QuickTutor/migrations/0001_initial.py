# Generated by Django 3.0.3 on 2020-02-17 21:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Student',
            fields=[
                ('USER_ID', models.IntegerField(default=2535787, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Tutor',
            fields=[
                ('USER_ID', models.IntegerField(default=9799361, primary_key=True, serialize=False)),
                ('firstName', models.CharField(default='', max_length=100)),
                ('lastName', models.CharField(default='', max_length=100)),
                ('major', models.CharField(default='', max_length=100)),
                ('year', models.CharField(default='', max_length=100)),
